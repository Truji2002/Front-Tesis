...
const FORM_IMAGE_URL = 'https://ekdmmus6foz.exactdn.com/wp-content/uploads/2023/07/9-80.jpg?strip=all&lossy=1&ssl=1&fit=1000%2C1000';
...
const Empresas = () => {
  ...
  return (
    <div className="empresas-container">
      ...
      {/* Contenedor Flex para el Formulario y la Imagen */}
      <div className="empresa-form-image-container">
        ...
        <form className="empresa-form" onSubmit={handleSubmit}>
          ...
          {/* Tercera Fila: Correo Electrónico y Número de Empleados */}
          <div className="form-row">
            <div className="form-group">
        ...
        <div className="empresa-form-image">
          <img src={FORM_IMAGE_URL} alt="Imagen relacionada con Empresas" />
        </div>
      </div>
